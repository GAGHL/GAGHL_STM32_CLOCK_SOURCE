...
static inline void RCC_Set_PLL_Multiplier_To_5(void)  { SBI(RCC->CFGR, RCC_CFGR_PLLMULL5);  }
static inline void RCC_Set_PLL_Multiplier_To_6(void)  { SBI(RCC->CFGR, RCC_CFGR_PLLMULL6);  }
static inline void RCC_Set_PLL_Multiplier_To_7(void)  { SBI(RCC->CFGR, RCC_CFGR_PLLMULL7);  }
static inline void RCC_Set_PLL_Multiplier_To_8(void)  { SBI(RCC->CFGR, RCC_CFGR_PLLMULL8);  }
static inline void RCC_Set_PLL_Multiplier_To_9(void)  { SBI(RCC->CFGR, RCC_CFGR_PLLMULL9);  }
static inline void RCC_Set_PLL_Multiplier_To_10(void) { SBI(RCC->CFGR, RCC_CFGR_PLLMULL10); }
static inline void RCC_Set_PLL_Multiplier_To_11(void) { SBI(RCC->CFGR, RCC_CFGR_PLLMULL11); }
static inline void RCC_Set_PLL_Multiplier_To_12(void) { SBI(RCC->CFGR, RCC_CFGR_PLLMULL12); }
static inline void RCC_Set_PLL_Multiplier_To_13(void) { SBI(RCC->CFGR, RCC_CFGR_PLLMULL13); }
